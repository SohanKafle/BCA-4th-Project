...
<head>
    ...
    <title>SK CAR RENTAL | Contact Us</title>
    ...
    <style>
        .contact {
            background-image: url(image/fun.jpg);
...
<body>
    ...
    <section>
        <div class="contact-text">
            ...
            <h3>Phone</h3>
            <p>Customer support: 078-564387/9812211443</p>
            <p>078-5576161</p>
            <p>9843752301</p>
            <br>
            <h3>Email</h3>
            <p>kaflesohan1@gmail.com</p>
            <br>
            <h3>Location</h3>
            <p>Nawalpur,Chitwan,Kathmandu</p>
        </div>
    </section>
